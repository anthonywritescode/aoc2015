...
def _run(regs: dict[str, int], instructions: list[Instruction]) -> None:
    while instructions:
        newinst = []
...
def compute(s: str) -> int:
    ...
    p2_instructions = [inst for inst in instructions if not inst.target == 'b']

    regs1: dict[str, int] = {}
    _run(regs1, instructions)

    regs2 = {'b': regs1['a']}
    _run(regs2, p2_instructions)
